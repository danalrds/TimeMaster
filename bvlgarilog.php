...
<html lang="en">
    <!--<![endif]-->
    <head>
        <title>TimeMaster/Bvlgari</title>
        <!-- Meta -->
                    ...
                    <div class="container">
                        ...
                        <div class="row margin-vert-30">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <img src="assets/img/portfolio/bvlgari.jpg" alt="about-me">
                                    </div>
                                    <div class="col-md-7">                                                              
                                     <p> Sotirios Boulgaris, born in an Aromanian village known as Kalarites began his career 
									  as a jeweller in his home village Paramythia (Epirus, Greece), where his first store
									  can still be seen. In 1877, he left for Corfu and then Naples. In 1881 he finally moved to Rome, 
									  where in 1884 he founded his company and opened his second shop in Via Sistina. The store in Via Sistina 
									  was then replaced by the current flagship store in Via dei Condotti opened in 1905 by Bulgari with the help 
									  of his two sons, Costantino (1889-1973) and Giorgio (1890-1966).</p>
									  <p>On 6 March 2011 French luxury group LVMH Moet Hennessy Louis Vuitton 
									  SA announced that it was acquiring Bulgari SpA in an all-share deal for 4.3 billion euros ($6.01 billion), 
									  higher than LVMH had offered for any other company. Under the deal, the Bulgari family sold their 50.4 per
									  cent controlling stake in exchange for 3 per cent of LVMH, thereby becoming the second-biggest family shareholder
									  behind the Arnaults in LVMH. The takeover doubled the size of LVMH's watches and jewellery unit, which at the time
									  of the acquisition included Tag Heuer timepieces and De Beers diamond necklaces. The acquisition concluded on 4 October
									  2011 as Bulgari was delisted from the Borsa Italiana.</p>
                                    </div>
                                </div>
                                <!-- My Work -->
								<br>
                                    ...
                                    <div class="portfolio-group margin-top-20">
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari1.jpg" alt="image1">
                                                        <figcaption>
                                                            <h3>BVLGARI LVCEA</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari2.jpg" alt="image2">
                                                        <figcaption>
                                                            <h3>BVLGARI OCTO</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari3.jpg" alt="image3">
                                                        <figcaption>
                                                            <h3>BVLGARI DIVA'S DREAM</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari4.jpg" alt="image4">
                                                        <figcaption>
                                                            <h3>BVLGARI B.ZERO1</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari5.jpg" alt="image5">
                                                        <figcaption>
                                                            <h3>BVLGARI BVLGARI</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari6.jpg" alt="image6">
                                                        <figcaption>
                                                            <h3>BVLGARI DIAGONO</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari7.jpg" alt="image7">
                                                        <figcaption>
                                                            <h3>BVLGARI HAUTE HORLOGERIE</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/bvlgari/bvlgari8.jpg" alt="image8">
                                                        <figcaption>
                                                            <h3>BVLGARI OCTEEA</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>

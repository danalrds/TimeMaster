                     ...
                     <div class="container">
                        ...
                        <div class="row margin-vert-30">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <img src="assets/img/portfolio/image5.jpg" alt="about-me">
                                    </div>
                                    <div class="col-md-7">                                                              
                                        <p>Hublot is a Swiss luxury watchmaker founded in 1980 by Italian Carlo Crocco. The company currently operates as a
										wholly owned subsidiary of France's LVMH. In 1980, it also marked the birth of the 'Fusion' concept a few months after
										being founded.</p>
                                        <p>A scion of the Italian Binda Group dynasty, best known for making Breil watches, Carlo Crocco left the company in 
										1976 to strike out on his own and create a new watch company. Moving to Switzerland he formed MDM Geneve and set about
										designing a watch that he named the Hublot after the French word for "porthole". The watch that he created featured 
										the first natural rubber strap in the history of watchmaking. It took 3 years of research to create the strap.
										Despite failing to attract a single potential customer on the first day of its debut at the 1980 Basel Watch Fair, 
										the watch quickly proved to be a commercial success with sales in excess of $2m in its first year.</p>
                                    </div>
                                </div>
                                <!-- My Work -->
								<br>
                                    ...
                                    <div class="portfolio-group margin-top-20">
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot1.jpg" alt="image1">
                                                        <figcaption>
                                                            <h3>HUBLOT SAPPHIRE RAINBOW</h3>                                                           
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot2.jpg" alt="image2">
                                                        <figcaption>
                                                            <h3>HUBLOT RED SAPPHIRE</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot3.jpg" alt="image3">
                                                        <figcaption>
                                                            <h3>HUBLOT FERRARI UNICO CARBONI</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot4.jpg" alt="image4">
                                                        <figcaption>
                                                            <h3>HUBLOT UNICO TITANIUM</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot5.jpg" alt="image5">
                                                        <figcaption>
                                                            <h3>HUBLOT TITANIUM KING GOLD</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot6.jpg" alt="image6">
                                                        <figcaption>
                                                            <h3>HUBLOT CHRONOGRAPH CERAMIC GOLD</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot7.jpg" alt="image7">
                                                        <figcaption>
                                                            <h3>HUBLOT AEROFUSION TITANIUM</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/hublot/hublot8.jpg" alt="image8">
                                                        <figcaption>
                                                            <h3>HUBLOT UNICO ITALIA INDEPENDENT CAMO</h3>                                                           
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>

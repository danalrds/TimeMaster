                ...
                <div class="primary-container">
                    ...
                    <div class="container">
                        ...
                        <div class="row margin-vert-30">
                            <div class="col-md-12">
                                <center><h2>Comenzi </h2></center>
                                <br><br>
                                <!-- End Filter Buttons -->
                            </div>
                          <?php 
	include "conectare.php";
    $query1 = "SELECT * FROM comenzi";
	...
	if ($nr>0)//daca exista cel putin o stire in tabela
	 {
		 ...
		 $query1 = "SELECT * FROM comenzi LIMIT $start,$rpp";
		 $rezultat=mysql_query($query1);
		 if ($succes=mysql_num_rows($rezultat)>0) 
			{			  
				...
				$id=$rand[0];
				?>
				<form method="post" action="deletecomanda.php">
					<input  type="hidden" name="id" value=" <?php echo $id; ?>">
					
					<input class="btn btn-primary pull-right" type="submit" value="STERGE" name="but">
			    </form>
				...
				//$str = preg_replace("/([a-z]+)/e","strtoupper('<small>\\1</small>')",$str);
		          ...
		          echo "<tr>";
							echo "<td align='left'>Cantitate: " .$rand[2]. "</td>"; 
							echo "<td align='center'>Adresa: " .$rand[5]. "</td>"; 
							echo "<td align='right'>Client: ".$mesaj. "</td>";	
							echo "<td align='right'>Postat: ".$rand[6]. "</td>";	
				echo"</tr>";
							?>
							</table> </center>
							<hr color ="#75461C" size="1px" style="width: 800px;"/> 
						     <p style="text-align: right; padding-right:130px; padding-top:0px; margin-top: -5px; margin-bottom: -10px;"> Valoare comanda: <?php echo"$dat" ?>$ 
	 ...
	 $nav='';//in nav creez  sirul ce contine numerotarea din partea de jos a paginii
			 ...
			 {
			   if ($pagina!=$i)
			     $nav .='<a style="color:#5E3400; text-decoration:none" href="comenzi.php?pg='.$i.'">'.$i.'</a>|';
			   else

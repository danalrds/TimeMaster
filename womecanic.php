...
<html lang="en">
    <!--<![endif]-->
    <head>
        <title>TimeMaster/Women/Mecanic</title>
        <!-- Meta -->
                ...
                <div class="primary-container">
                    ...
                    <div class="container">
                        ...
                        <div class="row margin-vert-30">
                            <div class="col-md-12">
                                <center><h2>Women Mechanical Watches </h2></center>
                                <br><br>
                                <!-- End Filter Buttons -->
                            </div>
                          <?php 
	include "conectare.php";
    $query1 = "SELECT * FROM womecanic ORDER BY data_p DESC";
	...
	if ($nr>0)//daca exista cel putin o stire in tabela
	 {
		 ...
		 $query1 = "SELECT * FROM womecanic ORDER BY data_p DESC LIMIT $start,$rpp";
		 $rezultat=mysql_query($query1);
	 ...
	 $nav='';//in nav creez  sirul ce contine numerotarea din partea de jos a paginii
			 ...
			 {
			   if ($pagina!=$i)
			     $nav .='<a style="color:#5E3400; text-decoration:none" href="womecanic.php?pg='.$i.'">'.$i.'</a>|';
			   else

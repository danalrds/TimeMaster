                   ...
                   <div class="container">
                        ...
                        <div class="row margin-vert-30">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <img src="assets/img/portfolio/rolex.jpg" alt="about-me">
                                    </div>
                                    <div class="col-md-7">                                                              
                                        <p> Rolex SA is a Swiss luxury watchmaker. The company and its subsidiary Montres Tudor SA design, manufacture,
										distribute and service wristwatches sold under the Rolex and Tudor brands. Founded by Hans Wilsdorf and Alfred Davis
										in London, England in 1905 as Wilsdorf and Davis, Rolex moved its base of operations to Geneva, Switzerland in 1919.
									   Forbes ranked Rolex 64th on its 2016 list of the world's most powerful global brands. Rolex is the largest single 
									   luxury watch brand, producing about 2,000 watches per day. The company is owned by the Hans Wilsdorf Foundation,
									   a family private trust which does not pay corporate tax.</p>
                                        <p>In December 2008, following the abrupt departure of Chief Executive Patrick Heiniger for "personal reasons", 
										the company denied that it had lost 1 billion Swiss francs (approx L574 million, $900 million) invested with 
										Bernard Madoff, the American asset manager who pleaded guilty to an approximately L30 billion worldwide Ponzi 
										scheme fraud. Rolex SA announced Heiniger's death on 5 March 2013. As of 2010 Rolex watches continue to have 
										a reputation as status symbols.</p>
                                    </div>
                                </div>
                                <!-- My Work -->
								<br>
                                    ...
                                    <div class="portfolio-group margin-top-20">
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex1.jpg" alt="image1">
                                                        <figcaption>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex2.jpg" alt="image2">
                                                        <figcaption>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex3.jpg" alt="image3">
                                                        <figcaption>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex4.jpg" alt="image4">
                                                        <figcaption>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex5.jpg" alt="image5">
                                                        <figcaption>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex6.jpg" alt="image6">
                                                        <figcaption>
										...
										<div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex7.jpg" alt="image8">
                                                        <figcaption>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/rolex/rolex8.jpg" alt="image8">
                                                        <figcaption>

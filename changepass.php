...
<html lang="en">
    <!--<![endif]-->
    <head>
        <title>TimeMaster/Create account</title>
        <!-- Meta -->
                        ...
                        <div class="container">
                            <div class="row margin-vert-30">
                                ...
                                <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                                    <form class="login-page" method="POST" action="schimbaparola.php">									    
                                        <div class="login-header margin-bottom-30">
                                            <h2>Change your old password</h2>
                                        </div>
                                        ...
                                        <div class="input-group margin-bottom-20">
											...
											<input class="form-control" placeholder=" New Password" type="password" name="pass" title="Password must be 8 characters including 1 uppercase letter, 1 lowercase letter and numeric characters" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" >
                                          										 
                                        </div>																	
                                        <div class="row">										                                                
                                            <div class="col-md-6">
                                                <button class="btn btn-primary pull-right" type="submit" name="but">Change password</button>
                                            </div>
                                        </div>
                                        <hr>                                        										
                                    </form>

...
<html lang="en">
	...
	if ($nr>0)//daca exista cel putin o stire in tabela
			  ...
			  if (is_dir($dir_foto))
			   {
				...
				$cantitate=$rand[5];
				?>
				<form method="post" action="deleteceas.php">
					<input  type="hidden" name="id" value=" <?php echo $id; ?>">
					<input  type="hidden" name="cat" value="woautomatic">
				...
				//$str = preg_replace("/([a-z]+)/e","strtoupper('<small>\\1</small>')",$str);
		          ...
		          echo "<tr>";
							...
							echo "<td align='center'>Nrprod: " .$rand[5]. "</td>"; 
	 ...
	 $nav='';//in nav creez  sirul ce contine numerotarea din partea de jos a paginii
			 ...
			 {
			   if ($pagina!=$i)
			     $nav .='<a style="color:#5E3400; text-decoration:none" href="woautomaticadmin.php?pg='.$i.'">'.$i.'</a>|';
			   else

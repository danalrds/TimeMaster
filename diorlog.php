                       ...
                       <div class="container">
                        ...
                        <div class="row margin-vert-30">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <img src="assets/img/portfolio/image6.jpg" alt="about-me">
                                    </div>
                                    <div class="col-md-7">                                                              
                                        <p>Christian Dior SE , commonly known as Dior, is a French luxury goods company controlled and chaired by French 
										businessman Bernard Arnault, who also heads LVMH - the world's largest luxury group. Dior itself holds 42.36% 
										shares of and 59.01% voting rights within LVMH.</p>

									<p>	Founded in 1946 by the eponymous designer Christian Dior, today the company designs and retails ready-to-wear, 
									leather goods, fashion accessories, footwear, jewelry, timepieces, fragrance, make-up, and skincare products while 
									also maintaining its tradition as a creator of recognized haute-couture (under the Christian Dior Couture division). 
									While the Christian Dior label remains largely for women's offerings, the company also operates the Dior Homme division 
									for men and the baby Dior label for children's wear. Products are sold throughout its portfolio of retail stores worldwide,
									as well as through its online store.</p>
                                    </div>
                                </div>
                                <!-- My Work -->
								<br>
                                    ...
                                    <div class="portfolio-group margin-top-20">
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior1.jpg" alt="image1">
                                                        <figcaption>
                                                            <h3>DIOR VIII ONDINE</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior2.jpg" alt="image2">
                                                        <figcaption>
                                                            <h3>DIOR NO5 AUTOMATIC</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior3.jpg" alt="image3">
                                                        <figcaption>
                                                            <h3>DIOR GRAND BAL PIECE</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior4.jpg" alt="image4">
                                                        <figcaption>
                                                            <h3>DIOR CHIFFRE ROUGE A06</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior5.jpg" alt="image5">
                                                        <figcaption>
                                                            <h3>DIOR AUTOMATIC MOUVEMENT</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior6.jpg" alt="image6">
                                                        <figcaption>
                                                            <h3>DIOR INVERSE 11</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior7.jpg" alt="image7">
                                                        <figcaption>
                                                            <h3>DIOR ROUGE C03</h3>                                                            
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <div class="portfolio-item col-md-3 col-sm-6 col-xs-6 animate fadeInUp">
                                            <div class="image-hover">
                                                <a href="#">
                                                    <figure>
                                                        <img src="assets/img/dior/dior8.jpg" alt="image8">
                                                        <figcaption>
                                                            <h3>DIOR M05 CALIBRE</h3>                                                           
                                                        </figcaption>
                                                    </figure>
                                                </a>
                                            </div>
